...
use libc::{c_void,c_int,c_uint,c_char,size_t,uint8_t,int64_t,c_double,uint64_t,c_float,int16_t,int8_t,uint32_t,c_short,uint16_t,c_uchar};
...
extern "C" {
    ...
    pub fn avcodec_configuration() -> *c_char;
    pub fn avcodec_license() -> *c_char;
    ...
    pub fn avcodec_find_decoder_by_name(name: *c_char) -> *mut AVCodec;
    ...
    pub fn avcodec_find_encoder_by_name(name: *c_char) -> *mut AVCodec;
    ...
    pub fn avcodec_set_dimensions(s: *mut AVCodecContext, width: c_int,
                                  height: c_int);
    pub fn av_get_codec_tag_string(buf: *mut c_char, buf_size: size_t,
                                   codec_tag: c_uint) -> size_t;
    pub fn avcodec_string(buf: *mut c_char, buf_size: c_int,
                          enc: *mut AVCodecContext, encode: c_int);
    pub fn av_get_profile_name(codec: *AVCodec, profile: c_int) -> *c_char;
    ...
    pub fn av_bitstream_filter_init(name: *c_char) ->
     *mut AVBitStreamFilterContext;
    ...
    pub fn av_log_missing_feature(avc: *mut c_void, feature: *c_char,
                                  want_sample: c_int);
    pub fn av_log_ask_for_sample(avc: *mut c_void, msg: *c_char, ...);
    ...
    pub fn avcodec_get_name(id: Enum_AVCodecID) -> *c_char;
     ...
     *AVCodecDescriptor;
    pub fn avcodec_descriptor_get_by_name(name: *c_char) ->
     *AVCodecDescriptor;
}
