...
extern crate libc;
use libc::{c_void,c_int,c_uint,c_char,size_t,uint8_t,int64_t,c_double,uint64_t,c_float,FILE,int8_t,uint32_t,c_short};
...
extern "C" {
    ...
    pub fn avutil_configuration() -> *c_char;
    pub fn avutil_license() -> *c_char;
    pub fn av_get_media_type_string(media_type: Enum_AVMediaType) -> *c_char;
    pub fn av_get_picture_type_char(pict_type: Enum_AVPictureType) -> c_char;
    pub fn av_strerror(errnum: c_int, errbuf: *mut c_char,
    ...
    pub fn av_strdup(s: *c_char) -> *mut c_char;
    ...
    pub fn av_add_stable(ts_tb: AVRational, ts: int64_t, inc_tb: AVRational,
                         inc: int64_t) -> int64_t;
    pub fn av_log(avcl: *mut c_void, level: c_int, fmt: *c_char, ...);
    pub fn av_vlog(avcl: *mut c_void, level: c_int, fmt: *c_char,
                   vl: va_list);
    ...
    pub fn av_log_default_callback(avcl: *mut c_void, level: c_int,
                                   fmt: *c_char, vl: va_list);
    pub fn av_default_item_name(ctx: *mut c_void) -> *c_char;
    pub fn av_default_get_category(ptr: *mut c_void) -> AVClassCategory;
    pub fn av_log_format_line(ptr: *mut c_void, level: c_int, fmt: *c_char,
                              vl: va_list, line: *mut c_char,
    ...
    pub fn av_fopen_utf8(path: *c_char, mode: *c_char) -> *mut FILE;
    pub fn av_get_sample_fmt_name(sample_fmt: Enum_AVSampleFormat) ->
     *c_char;
    pub fn av_get_sample_fmt(name: *c_char) -> Enum_AVSampleFormat;
    ...
    pub fn av_get_planar_sample_fmt(sample_fmt: Enum_AVSampleFormat) ->
     Enum_AVSampleFormat;
    pub fn av_get_sample_fmt_string(buf: *mut c_char, buf_size: c_int,
    ...
    pub fn av_samples_set_silence(audio_data: *mut *mut uint8_t,
                                  ...
                                  nb_channels: c_int,
                                  sample_fmt: Enum_AVSampleFormat) -> c_int;
    pub fn av_dict_get(m: *mut AVDictionary, key: *c_char,
                       prev: *AVDictionaryEntry, flags: c_int) ->
     *mut AVDictionaryEntry;
    pub fn av_dict_count(m: *AVDictionary) -> c_int;
    pub fn av_dict_set(pm: *mut *mut AVDictionary, key: *c_char,
                       value: *c_char, flags: c_int) -> c_int;
    pub fn av_dict_parse_string(pm: *mut *mut AVDictionary, str: *c_char,
                                key_val_sep: *c_char, pairs_sep: *c_char,
                                flags: c_int) -> c_int;
    ...
    pub fn av_get_channel_layout(name: *c_char) -> uint64_t;
    pub fn av_get_channel_layout_string(buf: *mut c_char, buf_size: c_int,
                                        nb_channels: c_int,
    ...
    pub fn av_get_channel_name(channel: uint64_t) -> *c_char;
    pub fn av_get_channel_description(channel: uint64_t) -> *c_char;
    pub fn av_get_standard_channel_layout(index: c_uint,
                                          layout: *mut uint64_t,
                                          name: *mut *c_char) -> c_int;
    pub fn av_find_opt(obj: *mut c_void, name: *c_char, unit: *c_char,
                       mask: c_int, flags: c_int) -> *AVOption;
    pub fn av_set_string3(obj: *mut c_void, name: *c_char, val: *c_char,
                          alloc: c_int, o_out: *mut *AVOption) -> c_int;
    pub fn av_set_double(obj: *mut c_void, name: *c_char, n: c_double) ->
     *AVOption;
    pub fn av_set_q(obj: *mut c_void, name: *c_char, n: AVRational) ->
     *AVOption;
    pub fn av_set_int(obj: *mut c_void, name: *c_char, n: int64_t) ->
     *AVOption;
    pub fn av_get_double(obj: *mut c_void, name: *c_char,
                         o_out: *mut *AVOption) -> c_double;
    pub fn av_get_q(obj: *mut c_void, name: *c_char, o_out: *mut *AVOption)
     -> AVRational;
    pub fn av_get_int(obj: *mut c_void, name: *c_char, o_out: *mut *AVOption)
     -> int64_t;
    pub fn av_get_string(obj: *mut c_void, name: *c_char,
                         o_out: *mut *AVOption, buf: *mut c_char,
                         buf_len: c_int) -> *c_char;
    ...
    pub fn av_set_options_string(ctx: *mut c_void, opts: *c_char,
                                 key_val_sep: *c_char, pairs_sep: *c_char)
     -> c_int;
    pub fn av_opt_set_from_string(ctx: *mut c_void, opts: *c_char,
                                  shorthand: **c_char, key_val_sep: *c_char,
                                  pairs_sep: *c_char) -> c_int;
    pub fn av_opt_free(obj: *mut c_void);
    pub fn av_opt_flag_is_set(obj: *mut c_void, field_name: *c_char,
                              flag_name: *c_char) -> c_int;
    pub fn av_opt_set_dict(obj: *mut c_void,
                           options: *mut *mut Struct_AVDictionary) -> c_int;
    pub fn av_opt_get_key_value(ropts: *mut *c_char, key_val_sep: *c_char,
                                pairs_sep: *c_char, flags: c_uint,
                                rkey: *mut *mut c_char,
                                rval: *mut *mut c_char) -> c_int;
    pub fn av_opt_eval_flags(obj: *mut c_void, o: *AVOption, val: *c_char,
                             flags_out: *mut c_int) -> c_int;
    pub fn av_opt_eval_int(obj: *mut c_void, o: *AVOption, val: *c_char,
                           int_out: *mut c_int) -> c_int;
    pub fn av_opt_eval_int64(obj: *mut c_void, o: *AVOption, val: *c_char,
                             int64_out: *mut int64_t) -> c_int;
    pub fn av_opt_eval_float(obj: *mut c_void, o: *AVOption, val: *c_char,
                             float_out: *mut c_float) -> c_int;
    pub fn av_opt_eval_double(obj: *mut c_void, o: *AVOption, val: *c_char,
                              double_out: *mut c_double) -> c_int;
    pub fn av_opt_eval_q(obj: *mut c_void, o: *AVOption, val: *c_char,
                         q_out: *mut AVRational) -> c_int;
    pub fn av_opt_find(obj: *mut c_void, name: *c_char, unit: *c_char,
                       opt_flags: c_int, search_flags: c_int) -> *AVOption;
    pub fn av_opt_find2(obj: *mut c_void, name: *c_char, unit: *c_char,
     ...
     *AVClass;
    pub fn av_opt_set(obj: *mut c_void, name: *c_char, val: *c_char,
                      search_flags: c_int) -> c_int;
    pub fn av_opt_set_int(obj: *mut c_void, name: *c_char, val: int64_t,
                          search_flags: c_int) -> c_int;
    pub fn av_opt_set_double(obj: *mut c_void, name: *c_char, val: c_double,
                             search_flags: c_int) -> c_int;
    pub fn av_opt_set_q(obj: *mut c_void, name: *c_char, val: AVRational,
                        search_flags: c_int) -> c_int;
    pub fn av_opt_set_bin(obj: *mut c_void, name: *c_char, val: *uint8_t,
                          size: c_int, search_flags: c_int) -> c_int;
    pub fn av_opt_set_image_size(obj: *mut c_void, name: *c_char, w: c_int,
                                 h: c_int, search_flags: c_int) -> c_int;
    pub fn av_opt_set_pixel_fmt(obj: *mut c_void, name: *c_char,
                                fmt: Enum_AVPixelFormat, search_flags: c_int)
     -> c_int;
    pub fn av_opt_set_sample_fmt(obj: *mut c_void, name: *c_char,
                                 fmt: Enum_AVSampleFormat,
                                 search_flags: c_int) -> c_int;
    pub fn av_opt_set_video_rate(obj: *mut c_void, name: *c_char,
                                 val: AVRational, search_flags: c_int) ->
     c_int;
    pub fn av_opt_set_channel_layout(obj: *mut c_void, name: *c_char,
                                     ch_layout: int64_t, search_flags: c_int)
     -> c_int;
    pub fn av_opt_get(obj: *mut c_void, name: *c_char, search_flags: c_int,
                      out_val: *mut *mut uint8_t) -> c_int;
    pub fn av_opt_get_int(obj: *mut c_void, name: *c_char,
                          search_flags: c_int, out_val: *mut int64_t) ->
     c_int;
    pub fn av_opt_get_double(obj: *mut c_void, name: *c_char,
                             search_flags: c_int, out_val: *mut c_double) ->
     c_int;
    pub fn av_opt_get_q(obj: *mut c_void, name: *c_char, search_flags: c_int,
                        out_val: *mut AVRational) -> c_int;
    pub fn av_opt_get_image_size(obj: *mut c_void, name: *c_char,
                                 search_flags: c_int, w_out: *mut c_int,
                                 h_out: *mut c_int) -> c_int;
    pub fn av_opt_get_pixel_fmt(obj: *mut c_void, name: *c_char,
                                search_flags: c_int,
                                out_fmt: *mut Enum_AVPixelFormat) -> c_int;
    pub fn av_opt_get_sample_fmt(obj: *mut c_void, name: *c_char,
                                 search_flags: c_int,
                                 out_fmt: *mut Enum_AVSampleFormat) -> c_int;
    pub fn av_opt_get_video_rate(obj: *mut c_void, name: *c_char,
                                 search_flags: c_int,
                                 out_val: *mut AVRational) -> c_int;
    pub fn av_opt_get_channel_layout(obj: *mut c_void, name: *c_char,
                                     search_flags: c_int,
                                     ch_layout: *mut int64_t) -> c_int;
    pub fn av_opt_ptr(avclass: *AVClass, obj: *mut c_void, name: *c_char) ->
     *mut c_void;
    pub fn av_opt_freep_ranges(ranges: *mut *mut AVOptionRanges);
    pub fn av_opt_query_ranges(arg1: *mut *mut AVOptionRanges,
                               obj: *mut c_void, key: *c_char, flags: c_int)
     -> c_int;
    pub fn av_opt_query_ranges_default(arg1: *mut *mut AVOptionRanges,
                                       obj: *mut c_void, key: *c_char,
                                       flags: c_int) -> c_int;
    ...
    pub fn av_get_colorspace_name(val: Enum_AVColorSpace) -> *c_char;
